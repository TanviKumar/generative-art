        ...
        draw() {
            ...
            for (let i = 0; i < this.sentence.length; i++) {
                ...
                if (current == "F" || current == "f") {
                    ...
                    let lineColor = p.lerpColor(p.color(this.colors[0]), p.color(this.colors[1]), i / this.sentence.length);
                    lineColor.setAlpha(35);
                    p.stroke(lineColor);
                    p.strokeWeight(10 + p.abs((p.sin((i + timer) / this.sentence.length * p.PI) * 20)));
                    //strokeWeight(30)
                    p.point(0, 0);
                    //point(0, -this.len)
