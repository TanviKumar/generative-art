...
let shades = ['#D1BCE3', '#585481', '#C49BBB','#B5B682', '#FEDC97', '#B5B682', '#28666E', '#7C9885']
...
p.draw = function() {
  ...
  p.stroke(0)
  let i = 1
  for (let y = padding + vSize / 2; y < p.height - padding; y += vSize / 2, i++) {
    for (let x = padding + hSize / 2; x < p.width - padding; x += hSize * 3 / 2) {
      if (i % 2)
        drawCell(x, y)
      else
